...
const QuantityButton = (props: BtnProps) => {
    ...
    return (
      <Grid container alignContent={"center"}>
        <Grid item xs={4}>
            <Typography variant="body1" className="leading-10 text-gray-300 text-center bg-gray-500" align="center">
                {data.qty}
            </Typography>
        </Grid>
        <Grid item xs={4}>
                ...
                <Grid container rowGap={1}>
                    ...
                    <Grid item xs={12}>
                        <Grid container justifyContent={"space-between"}>
                            ...
                            <Grid item xs={5}>
                                <Button onClick={()=> onRemove(data.id)} className="text-white bg-red-500 hover:bg-red-400 rounded-none" variant="contained" startIcon={<DeleteIcon/>}>
                                    Remove
                                </Button>
                            </Grid>
                        </Grid>
