...
const HomePage: NextPageWithLayout = () => {
  return (
    <header className="flex items-center relative h-screen">
      ...
      <motion.div
        className="flex flex-col absolute left-1/2 -translate-x-1/2 lg:left-0 lg:-translate-x-0 gap-12 md:gap-0 items-center lg:items-start w-full"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 1, duration: 0.5, ease: 'easeOut' }}>
        <span className="text-white z-10 text-4xl md:text-6xl uppercase text-center lg:text-start">
