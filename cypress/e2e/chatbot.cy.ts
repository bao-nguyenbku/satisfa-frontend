describe('Send Feedback', () => {
    it('reserve table successfully with chatbot', () => {
      ...
      cy.get('[style="transform: none; transform-origin: 0% 50% 0px;"] > :nth-child(1) > .flex > :nth-child(2)').click();
      ...
      cy.get(':nth-child(13) > .flex > .bg-neutral-100 > span').should('be.visible');
      /* ==== End Cypress Studio ==== */
    })
    it('order takeaway succesfully without rating', () => {
      ...
      /* ==== Generated with Cypress Studio ==== */
      cy.get(':nth-child(2) > .relative > .rounded-full').click();
      cy.get('[style="transform: none; transform-origin: 0% 50% 0px;"] > :nth-child(1) > .flex > :nth-child(3)').click();
    ...
    it('recommend food for customer with chatbot', () => {
      ...
      /* ==== Generated with Cypress Studio ==== */
      cy.get(':nth-child(2) > .relative > .rounded-full').click();
      cy.get('[style="transform: none; transform-origin: 0% 50% 0px;"] > :nth-child(1) > .flex > :nth-child(7)').click();
      cy.get('.w-full > .flex-1').clear();
      cy.get('.w-full > .flex-1').type('yes');
      cy.get('[data-testid="SendIcon"]').click();
      cy.get(':nth-child(9) > .flex > .bg-neutral-100 > span').should('be.visible');
      /* ==== End Cypress Studio ==== */
    })
  })